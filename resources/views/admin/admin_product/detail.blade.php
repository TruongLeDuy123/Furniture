...
<head>
    ...
    <script>
        ...
        async function fetchProduct() {
            ...
            tendm = await fetchCategories(data.MaDM);
            console.log("tendm: ", tendm);
            ...
            document.getElementById("DanhMucSp").value = tendm;
            console.log("chi tiet : ", data.ChiTiet);
        ...
        async function fetchCategories(madm) {
            console.log("madm: ", madm);
            const response = await fetch(`/api/categories/${madm}`);
            const data = await response.json();

            console.log("data.TenDM: ", data.TenDM);
            return data.TenDM;
        }
    </script>
</head>
                            ...
                            <form id="input-form">
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-8">
                                        ...
                                        <input readonly type="text" class="form-control" id="TenSP">
                                    </div>
                                    <div class="form-group col-md-4">
                                        <label for="NSX">Nhà sản xuất</label>
                                        <input readonly type="text" class="form-control" id="NSX">
                                    </div>
                                    <div class="form-group col-md-4">
                                        <label for="THieu">Thương hiệu</label>
                                        <input readonly type="text" class="form-control" id="THieu">
                                    </div>
                                    <div class="form-group col-md-4">
                                        <label for="DMSP">Danh mục SP</label>
                                        <input readonly type="text" class="form-control" id="DanhMucSp">
                                        <!-- <select readonly name="DanhMucSp" id="DanhMucSp" class="form-control"></select> -->
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label for="Gia">Giá</label>
                                        <input readonly type="number" min="0" class="form-control" id="Gia">
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label for="TongSL">Tổng SL</label>
                                        <input readonly type="number" min="0" class="form-control" id="TongSL">
                                    </div>

                                    <div class="form-group col-md-12">
                                        <label for="HinhAnh">Url hình ảnh</label>
                                        <input readonly type="text" class="form-control" id="HinhAnh">
                                    </div>

                                    <div class="form-group col-md-12">
                                        <label for="ChiTiet">Chi tiết</label>
                                        <textarea readonly type="text" class="form-control" rows="6" id="ChiTiet"></textarea>
                                    </div>
                                </div>
                                ...
                                <div class="d-grid d-flex justify-content-between">
                                    ...
                                    <!------ Button Chỉnh sửa ------>
                                    <a href="{{route('edit_product')}}" class="form-group btn btn-info btn-icon-split">
                                        <span class="icon text-white-50">
