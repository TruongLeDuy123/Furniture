...
<body id="page-top">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-flex justify-content-between">
                        <h1 class="h3 mb-2 text-gray-800">Chỉnh sửa thông tin hóa đơn</h1>
                        <!------ Button Xóa ------>
                        ...
                        <div class="col-md-8">
                            <form id="input-form">
                                ...
                                <div class="d-grid d-flex justify-content-between">
                                    <!------ Button Quay Lại ------>
                                    <a href="{{ url()->previous() }}" class="form-group btn btn-secondary btn-icon-split">
                                        <span class="icon text-white-50">
                                    ...
                                    <!------ Button Lưu ------>
                                    <a id="submitBtn" class="form-group btn btn-success btn-icon-split">
                                        <span class="icon text-white-50">
    ...
    <script>
        document.querySelector('#input-form').addEventListener("submit", function(event) {
            ...
            //DATA đã update
            var billId = document.getElementById('MaHD').value;
            var ttdhElement = document.getElementById('TTDH');
            var ttdh = ttdhElement.options[ttdhElement.selectedIndex].text;
            console.log();
            var ttttElement = document.getElementById('TTTT');
            var tttt = ttttElement.options[ttttElement.selectedIndex].text;
            ...
            $("#successModal").on("hidden.bs.modal", function() {
                ...
                window.location.href = "/detail_bill";
            });
