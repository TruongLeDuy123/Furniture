                        ...
                        <div class="col-md-4">
                            <form id="input-form">
                                ...
                                <div class="d-grid d-flex justify-content-between">
                                    <!------ Button Quay Lại ------>
                                    <a href="{{route('categories_manager')}}" asp-action="Index" class="form-group btn btn-secondary btn-icon-split">
                                        <span class="icon text-white-50">
    ...
    <script>
        document.querySelector('#input-form').addEventListener("submit", function(event) {
            ...
            $("#successModal").on("hidden.bs.modal", function() {
                window.location.href = "/detail_category"; // Thay đổi "/index" thành URL của trang index
            });
            // .catch(error => {
            //     console.error(error);
            // });
